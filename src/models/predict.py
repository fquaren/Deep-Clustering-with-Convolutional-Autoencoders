...
def pred(net, weigths, directory, scan, figures, exp, n):
...
def pred_all_on_train():
    ...
    print('Prediction on train image done.')
...
def pred_all_on_val():
    ...
    print('Prediction on val image done.')


def pred_all_on_test():
    n = random.randint(0, 10)
    for scan in cfg.scans:
        pred(
            cfg.net,
    ...
    print('Prediction on test image done.')
